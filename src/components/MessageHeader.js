			...
			<span className={styles.name}>
				<div
					className={`${styles.profile} ${
						styles[
							`${props.platform}-${props.DisplayPlatformColors}`
						]
					}`}>
					<Avatar
					...
					{props.badges.subscriber && (
						<Tooltip
							arrow
							title={props.badges.subscriber.title}
							placement="top">
							<img
								className={styles["sub-badge"]}
								src={props.badges.subscriber.image}
								alt=""></img>
						</Tooltip>
					)}
					{props.badges.founder && (
						<Tooltip
							arrow
							title={props.badges.founder.title}
							placement="top">
							<img
								className={styles["sub-badge"]}
								src={props.badges.founder.image}
								alt=""></img>
						</Tooltip>
					)}
